...
// Analog inputs.
static const GPIO_pin_t GPIO_ADC_IN9 =				(GPIO_pin_t) {GPIOB, 1, 1, 0};
static const GPIO_pin_t GPIO_ADC_IN8 =				(GPIO_pin_t) {GPIOB, 1, 0, 0};
static const GPIO_pin_t GPIO_ADC_IN0 =				(GPIO_pin_t) {GPIOA, 0, 0, 0};
// LCD.
