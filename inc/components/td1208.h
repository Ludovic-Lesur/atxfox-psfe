...
typedef enum {
	...
	TD1208_ERROR_BASE_USART2 = 0x0100,
	TD1208_ERROR_BASE_LPTIM1 = (TD1208_ERROR_BASE_USART2 + USART_ERROR_BASE_LAST),
	TD1208_ERROR_BASE_STRING = (TD1208_ERROR_BASE_LPTIM1 + LPTIM_ERROR_BASE_LAST),
