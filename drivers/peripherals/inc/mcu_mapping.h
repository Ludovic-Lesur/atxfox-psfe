...
#define ADC_CHANNEL_OUTPUT_VOLTAGE  ADC_CHANNEL_IN8
...
typedef enum {
    ...
    ADC_CHANNEL_INDEX_OUTPUT_VOLTAGE,
    ADC_CHANNEL_INDEX_OUTPUT_CURRENT,
...
extern const GPIO_pin_t GPIO_TRCS_OUTPUT_CURRENT_RANGE_LOW;
extern const GPIO_pin_t GPIO_TRCS_OUTPUT_CURRENT_RANGE_MIDDLE;
extern const GPIO_pin_t GPIO_TRCS_OUTPUT_CURRENT_RANGE_HIGH;
